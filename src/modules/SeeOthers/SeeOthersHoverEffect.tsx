...
export function SeeOthersHoverEffect({}) {
  return (
    <>
      <div className="z-10 absolute top-0 left-0 w-full h-full group-hover:backdrop-blur-[1px] group-hover:bg-[rgba(0,0,0,0.1)] rounded-xl"></div>
